...
{    
    ...
    y.setAttribute("value", "work_hours");
...
*/
    ...
    var result_2_ll = document.getElementById("result_2_ll").innerHTML = (work_hours * lavorazione_2) / 100;
    var result_3_ll = document.getElementById("result_3_ll").innerHTML = (work_hours * lavorazione_3) / 100;
    var result_4_ll = document.getElementById("result_4_ll").innerHTML = (work_hours * lavorazione_4) / 100;
    var result_5_ll = document.getElementById("result_5_ll").innerHTML = (work_hours * lavorazione_5) / 100;
    var result_6_ll = document.getElementById("result_6_ll").innerHTML = (work_hours * lavorazione_6) / 100;
    var result_7_ll = document.getElementById("result_7_ll").innerHTML = (work_hours * lavorazione_7) / 100;
